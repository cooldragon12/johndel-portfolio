...
export default function Landingpage() {
    ...
    return (
        <>
            ...
            <section ref={banner} className='h-screen overflow-hidden flex items-center ' id="banner">
                <div className='left-0 lg:left-24 absolute w-full h-[70%] lg:w-1/4  z-[-4]'>
                    <div className='w-full h-[4rem] text-[5rem] text-slate-50 font-bold top-1/4 text-center lg:left-4 lg:top-1/2 sticky'>
                        Me
                    </div>
                </div>
                <BannerSection />
            </section>
            <section ref={description} className='h-screen overflow-hidden  flex items-center' id="description">
            ...
            <section ref={project} className='h-screen overflow-hidden flex items-center' id="projects">
            ...
            <section ref={contact} className='h-screen overflow-hidden flex items-center justify-center' id="contact">
