    ...
    return (
        <>
            <div className="flex flex-col justify-center items-center lg:justify-center first-letter:lg:items-start  lg:w-1/3 h-full">
                <div className="flex flex-col justify-center items-center lg:items-start border border-primary p-5 h-1/2 border-collapse">
                ...
                <div className="flex flex-col justify-center items-center lg:items-start border border-primary p-5 h-1/4 border-collapse">
